...
_core__WEBPACK_IMPORTED_MODULE_1__["default"].prototype.modal = function (created) {
  for (let i = 0; i < this.length; i++) {
    const target = this[i].getAttribute('data-target'); //   scroll = calcScroll();             
    ...
    closeElements.forEach(elem => {
      Object(_core__WEBPACK_IMPORTED_MODULE_1__["default"])(elem).click(() => {
        ...
        document.body.style.overflow = ''; // document.body.style.marginRight = `0px`;
...
Object(_core__WEBPACK_IMPORTED_MODULE_1__["default"])('[data-toggle="modal"]').modal(); //Dynamic Modal Create
...
_core__WEBPACK_IMPORTED_MODULE_1__["default"].prototype.createModal = function ({
  ...
  for (let i = 0; i < this.length; i++) {
    ...
    modal.setAttribute('id', this[i].getAttribute('data-target').slice(1)); //btns = {count: num, settings: [[text, classNames = [], close, cb]]} - предворительнная структура настроики

    const buttons = [];

    for (let j = 0; j < btnCount; j++) {
      let btn = document.createElement('button');
      Object(_core__WEBPACK_IMPORTED_MODULE_1__["default"])(btn).addClass('btn', ...btnSettings[j][1]);
      ...
      if (btnSettings[j][3] && typeof btnSettings[j][3] === 'function') {
        Object(_core__WEBPACK_IMPORTED_MODULE_1__["default"])(btn).click(btnSettings[j][3]);
      }
...
Object(_lib_lib__WEBPACK_IMPORTED_MODULE_0__["default"])().get('http://jsonplaceholder.typicode.com/users').then(res => console.log(res));
